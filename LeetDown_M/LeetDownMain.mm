...
- (int) saveOTABlob {
    ...
    devVals.deviceModel = strdup([devmodel cStringUsingEncoding:NSASCIIStringEncoding]);
    devVals.deviceBoard = strdup([board cStringUsingEncoding:NSASCIIStringEncoding]);
    shshSavePath = [[RSpath stringByAppendingString:@"/LDResources/SHSH"] cStringUsingEncoding:NSASCIIStringEncoding];
    ret = isManifestSignedForDevice([buildmanifest cStringUsingEncoding:NSASCIIStringEncoding], &devVals, &versVals, serverUrl);
